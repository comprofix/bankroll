...
// Lets the bundled onboarding page (capacitor-www/) save/clear the user's
// chosen server URL and restart the Activity so MainActivity re-reads it and
// rebuilds the Capacitor bridge pointed there — see MainActivity.onCreate().
